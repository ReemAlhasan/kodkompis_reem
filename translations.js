...
const translations = {
  sv: {
    ...
    // Programming
    progTitle: "Programmering för barn & föräldrar",
    progIntro: "Välj den åldersgrupp som passar ditt barn bäst.",
  ...
  en: {
    ...
    heroLead: "Hi! I'm <strong>Reem</strong> and I'm studying to become a <strong>Civil Engineer in Media Technology and AI</strong>. I love helping children discover coding – like learning to talk to friendly robots.",
    ...
    // Programming
    progTitle: "Programming for children & parents",
    progIntro: "Choose the age group that best fits your child.",
  ...
  ar: {
    ...
    description: "ريم يعلم الأطفال والشباب البرمجة عبر الإنترنت – دورات وتدريب وورش عمل للأعمار من 6 إلى 16 عاماً.",
    ...
    heroLead: "مرحباً! أنا <strong>ريم</strong> وأدرس لأصبح <strong>مهندس مدني في تكنولوجيا الوسائط والذكاء الاصطناعي</strong>. أحب مساعدة الأطفال على اكتشاف البرمجة – مثل تعلم التحدث مع الروبوتات الودودة.",
    heroMathTitle: "تعلم الرياضيات عبر الإنترنت – بسهولة ومرونة",
    heroMathSub: "من المدرسة الابتدائية إلى الجامعة – ريم يشرح حتى تفهم.",
    heroBtnBook: "احجز درس",
    heroBtnCourses: "شاهد جميع الدورات",
    
    // About
    aboutTitle: "من هو ريم؟",
    aboutText: "أنا مدرب فضولي وهادئ أؤمن أن <em>الجميع</em> يمكنهم تعلم البرمجة. أدرس لأصبح <strong>مهندس مدني في تكنولوجيا الوسائط والذكاء الاصطناعي</strong> في جامعة لينشوبينغ وأستخدم تمارين ممتعة ومشاريع صغيرة وشرح واضح.",
    ...
    // Programming
    progTitle: "البرمجة للأطفال والآباء",
    progIntro: "اختر الفئة العمرية التي تناسب طفلك.",
    ...
    contactParentName: "اسم الوالد",
    contactEmail: "البريد الإلكتروني",
    contactPhone: "رقم الهاتف",
    contactChildAge: "عمر الطفل",
    contactMessage: "الرسالة",
    contactMessagePlaceholder: "يرجى إخبارنا بما أنت مهتم به…",
    contactConsent: "أوافق على استخدام معلوماتي حتى يتمكن ريم من الاتصال بي.",
    contactBtn: "إرسال",
    ...
    contactTrust1: "طالب هندسة مدنية في تكنولوجيا الوسائط والذكاء الاصطناعي",
